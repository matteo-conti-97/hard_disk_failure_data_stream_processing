...
\begin{frame}{Data Processing-Query 1 (2)}
    ...
    Per il calcolo online della media e della deviazione standard è stato utilizzato l'algoritmo di Welford in particolare, tali statistiche sono calcolate nell'aggreagate come:
    \begin{equation}
        \begin{aligned}
