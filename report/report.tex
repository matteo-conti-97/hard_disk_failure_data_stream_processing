...
\subsubsection{Query 1}
Si può notare che per la prima query i risultati per tutte le finestre sono abbastanza in linea tra loro per quanto rigaurda il throughput. Invece per quanto riguarda la latenza essa va 
\begin{figure}[H]
    \centering
