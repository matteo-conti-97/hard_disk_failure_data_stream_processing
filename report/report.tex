...
\begin{equation}
    \begin{aligned}
        ...
        \sigma^2_{k+1} &= \sigma^2_k + \frac{(x_{k+1} - \overline{x}_k)(x_{k+1} - \overline{x}_{k+1})-\sigma^2_k}{k+1}
    \end{aligned}
\end{equation}
...
Le metriche misurate per le 3 query sono la latenza ed il throughput. 
\begin{itemize}
...
\end{itemize}
Entrambe queste metriche sono disponibili tramite l'interfaccia web di Flink e sono accessibili tramite REST API. Le suddette metriche sono state campionate ad intervalli regolari di 1 secondo tramite uno script Python che fa richieste al job manager utilizzando le REST API di Flink e salva i risultati in un file CSV per poi graficarli.
\subsubsection{Query 1}
Si può notare come, per la prima query, le performance di tutte le finestre siano abbastanza in linea tra loro per quanto riguarda il throughput, presentando un andamento piuttosto regolare. Invece per quanto riguarda la latenza essa va a comparire sempre più tardi mano a mano che la finestra aumenta, questo probabilmente è dovuto al fatto che essa viene calcolata solo quando la finestra viene chiusa e quindi per finestre più grandi la latenza risulta essere maggiore perchè viene sperimentato un'attesa maggiore per la chiusura della stessa; infatti è anche possibile vedere che all'aumentare della taglia della finistra le variazioni avvengono con meno frequenza, fino ad avere latenza costante nella finestra globale
\begin{figure}[H]
    \centering
...
\end{figure}
\subsubsection{Query 2}
Anche per la query 2 valgono le stesse considerazioni della query1.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q2_w1_latency.png}
    \caption{Latency Query 2 - Window 1 day}
    \label{fig:query2_latency_w1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q2_w1_throughput.png}
    \caption{Throughput Query 2 - Window 1 day}
    \label{fig:query2_throughput_w1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q2_w2_latency.png}
    \caption{Latency Query 2 - Window 3 day}
    \label{fig:query2_latency_w2}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q2_w2_throughput.png}
    \caption{Throughput Query 2 - Window 3 day}
    \label{fig:query2_throughput_w2}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q2_w3_latency.png}
    \caption{Latency Query 2 - Window Global}
    \label{fig:query2_latency_w3}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q2_w3_throughput.png}
    \caption{Throughput Query 2 - Window Global}
    \label{fig:query2_throughput_w3}
\end{figure}
\subsubsection{Query 3}
Anche per la query 3 valgono le stesse considerazioni della query1.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q3_w1_latency.png}
    \caption{Latency Query 3 - Window 1 day}
    \label{fig:query3_latency_w1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q3_w1_throughput.png}
    \caption{Throughput Query 3 - Window 1 day}
    \label{fig:query3_throughput_w1}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q3_w2_latency.png}
    \caption{Latency Query 3 - Window 3 day}
    \label{fig:query3_latency_w2}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q3_w2_throughput.png}
    \caption{Throughput Query 3 - Window 3 day}
    \label{fig:query3_throughput_w2}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q3_w3_latency.png}
    \caption{Latency Query 3 - Window Global}
    \label{fig:query3_latency_w3}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{./res/q3_w3_throughput.png}
    \caption{Throughput Query 3 - Window Global}
    \label{fig:query3_throughput_w3}
\end{figure}
